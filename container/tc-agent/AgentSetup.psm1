# based on a novel of https://github.com/girwin/teamcity-agent-dsc/blob/master/TeamCityAgentDSC/DSCResources/cTeamCityAgent/cTeamCityAgent.psm1
...
function Set-TargetResource
{
    ...
    elseif ($Ensure -eq "Present" -and $currentResource["Ensure"] -eq "Absent")
    {
        ...
        Install-TeamCityAgent -AgentName $AgentName -AgentHomeDirectory $AgentHomeDirectory -AgentWorkDirectory $AgentWorkDirectory `
            ...
            -AgentPort $AgentPort -ServerHostname $ServerHostname -ServerPort $ServerPort `
...
function Install-TeamCityAgent
{
    ...
    Write-Verbose "Configuring TeamCity Agent with name: $AgentName, ownPort: $AgentPort, server hostname: $ServerHostname, server port: $ServerPort."
    ...
    #.\service.install.bat
	..\launcher\bin\TeamCityAgentService-windows-x86-64.exe -i ../conf/wrapper.conf
	#.\service.start.bat
	..\launcher\bin\TeamCityAgentService-windows-x86-64.exe -t ../conf/wrapper.conf
    Pop-Location
